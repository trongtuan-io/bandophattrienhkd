...
EXCEL_FILES = [
    ...
    'data/HUYEN QUY HOP CU (03 XA TAM HOP - MINH HOP- CHAU LOC.xlsx',
    'data/HUYEN QUE PHONG CU.xls'
]
...
if __name__ == '__main__':
    main()
    file_path = 'data/HUYEN QUY HOP CU (03 XA TAM HOP - MINH HOP- CHAU LOC.xlsx'

    # Đọc 10 dòng đầu từ một Sheet cụ thể
    # Lưu ý: Thay 'Tên_Sheet_Của_Bạn' bằng tên thực tế trong file Excel
